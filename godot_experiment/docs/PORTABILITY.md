...
Gem expansion shares existing PC/touch targeting and uses no platform-specific API. Persistent effects use bounded arrays and primitive meshes. Headless coverage is not mobile GPU/thermal validation; expanded effects still need physical-device profiling.
