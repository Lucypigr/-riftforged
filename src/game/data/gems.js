...
export const GEMS = [
  ...
  { id:'azure_arcshot', color:'blue', kind:'active', icon:'ϟ', name:'蒼藍躍電', text:'主動寶石：傷害稍低，但天生連鎖 1 次。', tags:['projectile'], active:{ damageMultiplier:.9, extraChain:1, projectileSpeedMultiplier:1.08, projectileColor:'#77c8ff' } },
  ...
  { id:'crimson_burst', color:'red', kind:'support', icon:'✹', name:'緋紅爆裂', text:'連線輔助：命中會對周圍敵人造成 45% 濺射傷害。', tags:['projectile'], support:{ damageMultiplier:.92, splashRadius:88, splashDamageMultiplier:.45 } },
  ...
  { id:'verdant_fork', color:'green', kind:'support', icon:'Y', name:'翠綠分岔', text:'連線輔助：首次命中後分裂成 2 枚較弱投射物。', tags:['projectile'], support:{ forks:2, forkDamageMultiplier:.72, damageMultiplier:.9 } },
  ...
  { id:'azure_reach', color:'blue', kind:'support', icon:'⇢', name:'蒼藍延伸', text:'連線輔助：投射物速度與飛行時間提高。', tags:['projectile'], support:{ projectileSpeedMultiplier:1.18, projectileLifetimeMultiplier:1.35, damageMultiplier:.96 } },
