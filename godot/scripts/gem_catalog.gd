...
const GEMS := {
    ...
    "azure_arcshot": {"id":"azure_arcshot", "color":"blue", "kind":"active", "icon":"ϟ", "name":"蒼藍躍電", "active":{"damage":0.90, "chain":1, "speed":1.08, "projectile_color":"77c8ff"}},
    ...
    "verdant_fork": {"id":"verdant_fork", "color":"green", "kind":"support", "icon":"Y", "name":"翠綠分岔", "support":{"forks":2, "fork_damage":0.72, "damage":0.90}},
